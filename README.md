...
**IT Infrastructure Veteran · AI Developer · SaaS Founder**  
📍 Macapá, Brazil · 🌐 Available for remote freelance work · 💬 English & Portuguese

---

## About Me

I'm a multidisciplinary technologist with **25+ years in IT infrastructure** (networks, servers, Linux, security) and a recent deep dive into **AI-driven development** — building agents, RAG pipelines, and production SaaS products.

My background is unusual: I spent a decade as a professional chef and gastronomic consultant before returning to tech full-time with a focus on AI. That cross-domain experience is what led me to build **Chefs Office**, a SaaS platform for professional kitchen management — live in production.

I work at the intersection of **solid infrastructure knowledge** and **modern AI tooling**, which means I can build things that actually run reliably in production — not just demos.
...
- **On-premise AI Agents** — RAG pipelines, document Q&A, STT/TTS voice agents using local models (Ollama)
- **SaaS Development** — full-stack products with Supabase + React + AI features
- **Infrastructure & Security** — Linux server setup, network hardening, firewall, VPN
